...
\begin{itemize}
    ...
    \item [IR\refstepcounter{irnum}\theirnum \label{IR_CompilingVerification}:] The system should have proper validation when cassifying the data for report generation.
    \textbf{Rationale:} It is essential to generate correct reports to aviod any future medical and diagnosis errors.
    ...
    \textbf{Rationale:} It is essential to produce accurate data to avoid any inaccurate records, potential medical errors and misdiagonsis. 
