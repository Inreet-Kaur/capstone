...
\begin{itemize}
    ...
    \item \textbf{Medication Prediction:}
...
\begin{itemize}
    ...
    \item [SR\refstepcounter{srnum}\thesrnum \label{SR_InputCheck}:] The system should filter out irrelevant parameters before feeding the data into the model. 
