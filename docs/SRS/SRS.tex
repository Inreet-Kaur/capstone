...
\textbf{Rationale:} This is a likely change because health network may want to reserve permission to make certain changes to healthcare professionals profiles for security reasons such as updating password.
...
\textbf{Rationale:} This is a likely change because health network may want to preserve certain entries for compliance and security reasons.
...
\textbf{Rationale:} This is a likely change because health network may have some policies that restrict the use of certain medicines.
\end{itemize}
...
\textbf{Rationale:} This is unlikely to change because health network are the primary bodies using this system for their staff and hospitals.
...
\textbf{Rationale:} This is unlikely to change because health network must be able to update their organizational and hospital information..
...
\textbf{Rationale:} This is unlikely to change because this is a the key functionality that address the overhead of the healthcare documentation process. 
...
\textbf{Rationale:} This is unlikely to change because this requirement is essentials to collobrate with other health networks that user another documentation service.
\end{itemize}
...
\noindent \begin{itemize}
  ...
  \textbf{Rationale:} This is unlikely to change because this is a key functionality that address the overhead of the healthcare documentation process.
